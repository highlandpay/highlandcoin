...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight >= 12)     nSubsidy = 1 * COIN;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if(nBestHeight >= 210000 && nBestHeight < 315000){
        nSubsidy = 60 * COIN;
    }
    else if(nBestHeight >= 315000 && nBestHeight < 420000){
        nSubsidy = 56 * COIN;
    }
    else if(nBestHeight >= 420000 && nBestHeight < 525000){
        nSubsidy = 52 * COIN;
    }
    else if(nBestHeight >= 525000 && nBestHeight < 630000){
        nSubsidy = 48 * COIN;
    }
    else if(nBestHeight >= 630000 && nBestHeight < 735000){
        nSubsidy = 44 * COIN;
    }
    else if(nBestHeight >= 735000 && nBestHeight < 840000){
        nSubsidy = 40 * COIN;
    }
    else if(nBestHeight >= 840000 && nBestHeight < 945000){
        nSubsidy = 36 * COIN;
    }
    else if(nBestHeight >= 945000 && nBestHeight < 1050000){
        nSubsidy = 32 * COIN;
    }
    else if(nBestHeight >= 1050000 && nBestHeight < 1155000){
        nSubsidy = 28 * COIN;
    }
    else if(nBestHeight >= 1155000 && nBestHeight < 1260000){
        nSubsidy = 24 * COIN;
    }
    else if(nBestHeight >= 1260000 && nBestHeight < 1365000){
        nSubsidy = 20 * COIN;
    }
    else if(nBestHeight >= 1365000 && nBestHeight < 1470000){
        nSubsidy = 16 * COIN;
    }
    else if(nBestHeight >= 1470000 && nBestHeight < 1575000){
        nSubsidy = 12 * COIN;
    }
    else if(nBestHeight >= 1575000 && nBestHeight < 1680000){
        nSubsidy = 8 * COIN;
    }
    else if(nBestHeight >= 1680000 && nBestHeight < 1785000){
        nSubsidy = 4 * COIN;
    }
    else if(nBestHeight >= 1785000){
