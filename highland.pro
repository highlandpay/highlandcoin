...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        win32:SECP256K1_LIB_PATH=/mingw32/lib/
		}
    isEmpty(SECP256K1_INCLUDE_PATH) {
        win32:SECP256K1_INCLUDE_PATH=/mingw32/include
    }
}
...
macx:ICON = src/qt/res/icons/Highland.icns
macx:TARGET = "Highland"
